...
namespace Vehicle.Infrastructure.Migrations
{
    ...
    [Migration("20260505065938_AddVendorPartSaleInvoiceFeatures")]
    partial class AddVendorPartSaleInvoiceFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.Part", b =>
                {
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.SaleInvoice", b =>
                {
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.SaleInvoiceItem", b =>
                {
                    b.Property<int>("SaleInvoiceItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SaleInvoiceItemID"));
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.Vendor", b =>
                {
                    b.Property<int>("VendorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.Part", b =>
                {
                    b.HasOne("Vehicle.Domain.Models.Vendor", "Vendor")
                        .WithMany("Parts")
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.SaleInvoice", b =>
                {
                    ...
                    b.HasOne("Vehicle.Domain.Models.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("Vehicle.Domain.Models.SaleInvoiceItem", b =>
                {
                    b.HasOne("Vehicle.Domain.Models.SaleInvoice", "Invoice")
                        .WithMany("Items")
                        .HasForeignKey("InvoiceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vehicle.Domain.Models.Part", "Part")
                        .WithMany()
